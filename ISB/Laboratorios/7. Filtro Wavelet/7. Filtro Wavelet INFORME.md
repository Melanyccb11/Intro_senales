...
<h5 align="center">
  <i>Figura 15: Comparación de señal original con filtrada. [Elaboración propia]</i></div></h5>
<p>
...
<img width="600" height="500" src="https://github.com/Melanyccb11/Intro_senales/blob/main/ISB/Laboratorios/7. Filtro Wavelet/Imágenes/EMG_SIGNAL_X_FILTERED.png"> 
<h5 align="center">
  <i>Figura 17: Comparación de señal original con filtrada. [Elaboración propia]</i></div></h5>
<p>
...
#Discusión
1. ECG
- Reposo: La señal ECG en reposo mostró un ritmo regular y estable, consistente con un estado de reposo donde el corazón late a una frecuencia constante. La descomposición wavelet en niveles altos reveló la estabilidad del ritmo cardíaco sin grandes fluctuaciones.
- Inhalando/Manteniendo/Exhalando: Las variaciones en la señal ECG durante las fases de respiración reflejan la influencia del sistema respiratorio en la actividad cardíaca. Las fluctuaciones más marcadas en los niveles de detalle indican cómo la respiración afecta el ritmo cardíaco.
- Después de un Ejercicio Físico: El aumento en la frecuencia y amplitud de la señal ECG tras el ejercicio físico muestra la respuesta del corazón al estrés físico. Los patrones más caóticos en los coeficientes de detalle reflejan la recuperación y adaptación del ritmo cardíaco.

2. EEG
- Reposo: La señal EEG en reposo mostró una actividad cerebral moderada y estable, reflejando un estado de relajación. Los niveles de detalle en frecuencias bajas confirmaron un estado de descanso.
- Abrir y Cerrar los Ojos: La señal EEG respondió rápidamente a los estímulos visuales, con picos de actividad en los momentos de apertura y cierre de los ojos. Los coeficientes de detalle en niveles altos mostraron estas transiciones rápidas.
- Resolviendo Ejercicios Matemáticos: El aumento en la actividad cerebral durante la resolución de ejercicios matemáticos refleja el esfuerzo cognitivo. Las fluctuaciones más pronunciadas y la mayor actividad en los niveles de detalle indican un procesamiento mental intenso.

3. EMG
- Reposo: La señal EMG en reposo mostró una actividad muscular mínima, lo cual es esperado ya que los músculos no están siendo activamente utilizados. La estabilidad en los niveles de detalle confirmó la ausencia de contracción muscular significativa.
- Contracción Leve: La señal EMG durante una contracción leve mostró un aumento en las fluctuaciones, reflejando una actividad muscular sostenida de baja intensidad. Los niveles de detalle mostraron una actividad muscular constante.
- Contracción Fuerte: La señal EMG durante una contracción fuerte presentó fluctuaciones significativas y de alta amplitud, indicando una intensa actividad muscular. Los coeficientes de detalle confirmaron la fuerte contracción muscular sostenida.
