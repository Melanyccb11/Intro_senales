...
- Intervalo RR: La distancia entre los complejos QRS consecutivos es el intervalo RR, que nos informa sobre la frecuencia cardíaca [1]. A simple vista, este intervalo parece durar ligeramente menos de 1 segundo por lo cual la frecuencia cardíaca sería aproximadamente mayor a 60 latidos por minuto.
...
- Segmento ST: Tiene una duración de 0.25 segundos correspondiente a un latido normal de duración aproximada de un 1 segundos [1].
...
Al interpretar los resultados del balbalbalbalblablkablab HABLAR DE LA EXPERIENCIA DE JUANJO
